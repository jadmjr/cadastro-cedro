...
public class InformacoesPessoais3 extends Selenium {
	...
	public InformacoesPessoais3 setPasDeNascimentoSearchField(String pasDeNascimentoValue) {
		...
		pasDeNascimento.clear();
		esperar(250);
		pasDeNascimento.sendKeys(pasDeNascimentoValue);
		esperar(500);
		pasDeNascimento.sendKeys(Keys.ARROW_DOWN);
		esperar(250);
		driver.findElement(By.className("cdk-overlay-pane")).click();
		return this;
	}
	...
	/**
	 * Set Upload Do Documento De Identificao Com Cpf Do Representante Legal Arraste
	 * O Documento Aqui Ou Selecione Atravs Do Seu Dispositivo Apenas Arquivos Png
	 * Jpg Jpeg Gif E Pdf File field.
	 *
	 * @return the Temp class instance.
	 */
