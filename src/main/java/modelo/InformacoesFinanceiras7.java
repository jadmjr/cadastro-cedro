...
public class InformacoesFinanceiras7 {
     ...
     * @return the Setima class instance.
     */
    public InformacoesFinanceiras7 clickStandartButton() {
        standart.click();
        return this;
    }
     ...
     * @return the Setima class instance.
     */
    public InformacoesFinanceiras7 setBensImveisTextField() {
     ...
     * @return the Setima class instance.
     */
    public InformacoesFinanceiras7 setBensImveisTextField(String bensImveisValue) {
     ...
     * @return the Setima class instance.
     */
    public InformacoesFinanceiras7 setOutrosBensEValoresTextField() {
     ...
     * @return the Setima class instance.
     */
    public InformacoesFinanceiras7 setOutrosBensEValoresTextField(String outrosBensEValoresValue) {
